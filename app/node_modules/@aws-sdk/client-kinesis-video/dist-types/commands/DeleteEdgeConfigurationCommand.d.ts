 ...
 *
 */
export declare class DeleteEdgeConfigurationCommand extends $Command<DeleteEdgeConfigurationCommandInput, DeleteEdgeConfigurationCommandOutput, KinesisVideoClientResolvedConfig> {
    readonly input: DeleteEdgeConfigurationCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: DeleteEdgeConfigurationCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: KinesisVideoClientResolvedConfig, options?: __HttpHandlerOptions): Handler<DeleteEdgeConfigurationCommandInput, DeleteEdgeConfigurationCommandOutput>;
    /**
     * @internal
     */
    private serialize;
