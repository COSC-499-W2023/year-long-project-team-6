 ...
 *
 */
export declare class ListEdgeAgentConfigurationsCommand extends $Command<ListEdgeAgentConfigurationsCommandInput, ListEdgeAgentConfigurationsCommandOutput, KinesisVideoClientResolvedConfig> {
    readonly input: ListEdgeAgentConfigurationsCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: ListEdgeAgentConfigurationsCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: KinesisVideoClientResolvedConfig, options?: __HttpHandlerOptions): Handler<ListEdgeAgentConfigurationsCommandInput, ListEdgeAgentConfigurationsCommandOutput>;
    /**
     * @internal
     */
    private serialize;
