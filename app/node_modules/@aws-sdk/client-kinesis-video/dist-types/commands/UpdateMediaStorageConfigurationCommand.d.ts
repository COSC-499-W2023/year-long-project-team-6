...
export declare class UpdateMediaStorageConfigurationCommand extends $Command<UpdateMediaStorageConfigurationCommandInput, UpdateMediaStorageConfigurationCommandOutput, KinesisVideoClientResolvedConfig> {
     ...
     * @public
     */
    constructor(input: UpdateMediaStorageConfigurationCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: KinesisVideoClientResolvedConfig, options?: __HttpHandlerOptions): Handler<UpdateMediaStorageConfigurationCommandInput, UpdateMediaStorageConfigurationCommandOutput>;
    /**
     * @internal
     */
    private serialize;
