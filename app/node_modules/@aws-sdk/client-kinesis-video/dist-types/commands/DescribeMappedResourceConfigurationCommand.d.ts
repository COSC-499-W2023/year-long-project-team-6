...
export declare class DescribeMappedResourceConfigurationCommand extends $Command<DescribeMappedResourceConfigurationCommandInput, DescribeMappedResourceConfigurationCommandOutput, KinesisVideoClientResolvedConfig> {
     ...
     * @public
     */
    constructor(input: DescribeMappedResourceConfigurationCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: KinesisVideoClientResolvedConfig, options?: __HttpHandlerOptions): Handler<DescribeMappedResourceConfigurationCommandInput, DescribeMappedResourceConfigurationCommandOutput>;
    /**
     * @internal
     */
    private serialize;
