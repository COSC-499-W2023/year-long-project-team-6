...
export declare class DescribeEdgeConfigurationCommand extends $Command<DescribeEdgeConfigurationCommandInput, DescribeEdgeConfigurationCommandOutput, KinesisVideoClientResolvedConfig> {
     ...
     * @public
     */
    constructor(input: DescribeEdgeConfigurationCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: KinesisVideoClientResolvedConfig, options?: __HttpHandlerOptions): Handler<DescribeEdgeConfigurationCommandInput, DescribeEdgeConfigurationCommandOutput>;
    /**
     * @internal
     */
    private serialize;
