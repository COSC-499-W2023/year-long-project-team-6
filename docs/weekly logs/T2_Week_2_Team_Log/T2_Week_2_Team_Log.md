...
## Milestone Goals
Group funcion in the Homepage complete 

Receiver view video inside of group 

sender can also view the video that send to the group

add group function

find group function

Revision on the profile page

When user creater group, it will automatically become receiver

Change the database

User downloading the video
...
Group function on the main page

Update the database

Profile page have the completed functionality
...
Receiver can receive the video and user create group, automatically be receiver

sender view the video in the group
